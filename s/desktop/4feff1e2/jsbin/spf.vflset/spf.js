(function() {
    ...
    */
    ...
    function za() {
        if (ya !== ya) throw Error("SafeStyleSheet is not meant to be built directly");
    }
    ...
    */
    ...
    function Sa(a) {
        a.data && Pa(a.data) && 0 == a.data.lastIndexOf("spf:", 0) && Ta(a.data.substring(4))
    }
    ...
    Ua = x["async-defers"];
    Xa && ("async-listener" in x && Wa(x["async-listener"]), Va(Sa), w("async-listener", Sa));
    var Za = {
    ...
    function E(a, b) {
        b && (a.classList ? a.classList.add(b) : eb(a, b) || (a.className += " " + b))
    }
    ...
    function kb(a, b, c, d) {
        if (b || c) {
            ...
            c["spf-timestamp"] = e;
            if (a) lb(c, b);
            else if (a = mb().contentWindow.history.pushState, "function" == typeof a) a.call(window.history, c, "", b);
    ...
    function nb(a) {
        ...
        if (x["history-ignore-pop"]) w("history-ignore-pop", !1);
            ...
            b == x["history-url"] ? (w("history-timestamp", c), lb(a, b)) : (a["spf-back"] = c < parseInt(x["history-timestamp"], 10), a["spf-current"] = x["history-url"], w("history-timestamp", c), w("history-url", b), (c = x["history-callback"]) && c(b, a))
        }
    }
    ...
    function pb(a, b) {
        a in G && b && La(G[a], function(c, d, e) {
    ...
    function rb(a, b) {
        ...
        if (c && (vb(c), 0 < c.G && c.items.length)) {
            ...
            d && (a = n(function(e, f) {
                f();
                e()
            }, null, n(rb, null, a, b)), b ? (c.items.shift(), a(d.I)) : wb(c, d, a))
        }
    }

    function wb(a, b, c) {
        b.delay ? (c = n(c, null, Ka), a.v = setTimeout(c, b.delay), b.delay = 0) : (a.items.shift(), c = n(c, null, b.I), (b = (b = A["advanced-task-scheduler"]) && b.addTask) ? a.A = b(c) : a.v = setTimeout(c, 0))
    }
    ...
    */
    function Ab(a, b, c, d) {
        ...
        c && (h = Q[P(a, c)]) && b != h && (p(e ? "spfjsbeforeunload" : "spfcssbeforeunload", {
            name: c,
            url: h
        }), e = h, delete Q[P(a, c)], e && delete S[P(a, e)], delete G[P(a, c)], ob(g, n(Bb, null, a, c, h)));
        if ((e = S[P(a, b)]) && f != e) {
            delete Q[P(a, e)];
            delete S[P(a, b)];
            var k = P(a, e);
        ...
        ob(g, d);
        d = n(Cb, null, a);
        T[P(a, b)] ? (e && f != e && (a = Db(a, b)) && a.setAttribute("name", c || ""), d()) : (a = Eb(a, b, d, void 0, void 0,
    ...
    function Cb(a) {
        var b = P(a, ""),
            c;
        for (c in G) 0 == c.indexOf(b) && La(c.substring(b.length).split("|"), n(Hb, null, a)) && qb(c)
    }
    ...
    function Eb(a, b, c, d, e, f) {
        ...
        h ? (m.async = !0, Fa(m, Ia(b)), d.insertBefore(m, d.firstChild)) : (m.rel =
            "stylesheet", m.href = b, (f = f ? Db(a, f, d) : null) ? d.insertBefore(m, f) : d.appendChild(m));
        return m
    }
    ...
    function Mb(a, b, c, d, e) {
        ...
        f ? (h = a.createElement("object"), Nb ? a.createElement("script").src = c : h.data = c, h.id = d, a.body.appendChild(h)) : g ? (h = Eb(b, c, null, a, e), h.id = d) : (h = a.createElement("img"), Nb && (c = c + "#" + q()), h.src = c, h.id = d, a.body.appendChild(h))
    }
    ...
    function Ob(a, b, c) {
        ...
        f = "hash-" + g;
        Q[P(a, c)] = f;
        !Pb(a, f) && (b = Qb(a, b)) && (T[P(a, f)] = 2, b && !d && (d = Ib(f), b.className = P(a, d), b.setAttribute("name", c)), (e = e && e[0]) && Gb(a, e))
    }
    ...
    */
    function fc(a, b, c) {
        if (b) {
            ...
            e = a.indexOf("]\r\n", d); - 1 < e && (f = Qa(a.substring(d, e)), d = e + 3, f && b.push(JSON.parse(f)));
            f = "";
    ...
    function V(a, b, c, d) {
        ...
        e && b.url && N(b.url) != N(window.location.href) && jb(b.url + window.location.hash);
        ...
        b.attr && (u = n(function(t, C) {
            for (var H in t) {
                ...
                if (M) {
                    ...
                    for (R in mc) {
                        var wa = mc[R];
                        "class" == R ? M.className = wa : "style" == R ? M.style.cssText = wa : (M.setAttribute(R, wa), "value" == R && (M[R] = wa))
                    }
                }
            }
            C.spfProcessAttr = q()
        ...
        for (Ya in I) u = n(function(t, C) {
            if (t = document.getElementById(t)) {
                ...
                C = A["animation-class"];
                kc && eb(t, C) ?
                    (t = new lc(t, H.html, C, k, !!f), sb(m), L(t.key, !0), J(t.key, n(nc, null, t), 0), J(t.key, n(oc, null, t), 17), J(t.key, n(pc, null, t), t.duration), J(t.key, n(function() {
                        M();
                        tb(m, B)
                    }, null), 0), L(t.key)) : (C = A["experimental-html-handler"]) ? (sb(m), C(H.html, t, function() {
                        M();
                        tb(m, B)
                    })) : (Ea(t, Ga(H.html)), M())
            }
        }, null, Ya, I[Ya], b.timing), u = J(m, u);
        I = u - kd;
    ...
    function W(a) {
        var b = new tc;
        if (!a) return b;
        if (!Pa(a)) return a.scripts && r(a.scripts, function(c) {
            b.scripts.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || "",
        ...
        a = a.replace(uc, function(c, d, e, f) {
            ...
            return "style" == d && (d = (d = e.match(vc)) ? d[1] : "", e = yc.exec(e), e = !e || -1 != e[1].indexOf("text/css")) ? (b.styles.push({
                url: "",
                text: f,
                name: d
            }), "") : c
        ...
        a = a.replace(zc, function(c, d) {
            var e = d.match(Ac);
            e = e ? e[1] : "";
            return "stylesheet" == e ? (e = (e = d.match(vc)) ? e[1] : "", d = (d = d.match(Bc)) ? d[1] : "", b.styles.push({
                url: d,
                text: "",
                name: e
            }), "") : "spf-preconnect" == e ? (d = (d = d.match(Bc)) ? d[1] : "", b.links.push({
                url: d,
                rel: e
            }), "") : c
        });
            ...
            var c = -1,
                d = function() {
                    ...
                    if (c < a.scripts.length) {
                        var e = a.scripts[c],
                            f = function() {};
                        e.url ? f = e.name ? n(Sb, null, e.url, e.name) : n(Ub, null, e.url) : e.text && (f = e.name ? n(ac, null, e.text, e.name) : n(bc, null, e.text));
    ...
    function sc(a) {
        0 >= a.scripts.length || (a = Oa(a.scripts, function(b) {
            return b.url
        }), Vb(a))
    }
    ...
    function ic(a) {
        0 >= a.styles.length || r(a.styles, function(b) {
            b.url ? b.name ? cc(b.url, b.name) : dc(b.url) : b.text && (b.name ? Ob("css", b.text, b.name) : Qb("css", b.text))
        })
    }

    function rc(a) {
        0 >= a.styles.length || (a = Oa(a.styles, function(b) {
            return b.url
        }), ec(a))
    }

    function hc(a) {
        0 >= a.links.length || (a = Oa(a.links, function(b) {
    ...
    var kc = function() {
            ...
            return "transition" in a.style ? !0 : Ma(["webkit", "Moz", "Ms", "O", "Khtml"], function(b) {
                return b + "Transition" in a.style
            })
        }(),
        zc = /\x3clink([\s\S]*?)\x3e/ig,
        uc = /\x3c(script|style)([\s\S]*?)\x3e([\s\S]*?)\x3c\/\1\x3e/ig,
        xc = /(?:\s|^)async(?:\s|=|$)/i,
        Bc = /(?:\s|^)href\s*=\s*["']?([^\s"']+)/i,
        vc = /(?:\s|^)name\s*=\s*["']?([^\s"']+)/i,
        Ac = /(?:\s|^)rel\s*=\s*["']?([^\s"']+)/i,
    ...
    function Cc(a, b, c, d) {
        ...
        k.onreadystatechange = function() {
            ...
            if (2 == k.readyState) {
                ...
                e.N && e.N(k)
            } else 3 == k.readyState ? f && e.C && (u = k.responseText.substring(g), g = k.responseText.length, e.C(k, u)) : 4 == k.readyState && (u.responseEnd = u.responseEnd || q(), window.performance && window.performance.getEntriesByName && (k.resourceTiming = window.performance.getEntriesByName(b).pop()), f && e.C && k.responseText.length > g && (u = k.responseText.substring(g), g = k.responseText.length, e.C(k, u)), clearTimeout(h), e.M && e.M(k))
        };
    ...
    function Dc(a, b) {
        ...
        if (g) {
            ...
            b = b.uid = m;
            Ua[b] = a;
            Xa ? window.postMessage("spf:" + b, "*") : window.setTimeout(n(Ta, null, b), 0);
            return null
        }
        g = {};
        ...
        return "POST" == b.method ? Cc("POST", d, b.H, a) : Cc("GET", d, null,
            a)
    }
    ...
    function Gc(a, b, c, d, e) {
        ...
        b.type && 0 == b.type.lastIndexOf("navigate", 0) && (c.navigationStart = c.startTime, A["cache-unified"] || ($a(d), f = !0));
        b.o && "multipart" == e.type && r(e.parts, function(g) {
            g.timing || (g.timing = {});
    ...
    function Lc(a, b, c, d, e) {
        if (e && "POST" != b.method && (e = Ec(a, b.current, d.cacheType, b.type, !0))) {
            d.cacheKey = e;
            var f = {
                    response: d,
                    type: b.type || ""
    ...
    function Ec(a, b, c, d, e) {
        ...
        b && "url" == c ? f += " previous " + b : b && "path" == c && (f += " previous " + xb(b).pathname);
        return f || ""
    }

    function Fc(a, b) {
        var c = [];
        b && (c.push(a + " previous " + b), c.push(a + " previous " + xb(b).pathname));
        c.push(a);
        var d = null;
        Ma(c, function(e) {
            a: {
    ...
    function Pc(a) {
        ...
        var b = Mc(a.target);
        return !b || A["nolink-class"] && Nc(a.target) ? null : (a = Oc(a.target, b)) ? a.href : null
    }
    ...
    function $c(a, b) {
        ...
        c && (a = yb(a, [c]));
        Qc(a) ? Rc() ? p("spfhistory", {
            url: a,
            referer: b.i,
            previous: b.current
        }) && (b.position && (w("nav-scroll-position", [window.pageXOffset, window.pageYOffset]), w("nav-scroll-url", window.location.href)), Uc(a, {}, b)) : X(a, "1") : X(a, "9")
    }
    ...
    function Uc(a, b, c) {
        ...
        if (Sc(a, c.current))
            if (bd(a, c.i, c.current, b)) {
                ...
                if (d && 4 != d.readyState) d = "preprocess " + N(a), e = "promote " + N(a), w("nav-promote", a), w("nav-promote-time", q()), ub(d), L(e, !0), c.history || ed(a, c.i, n(Y, null, b));
                else {
                    d = n(Y, null, b);
                    e = n(fd, null, b, c);
                    var f = n(gd, null,
    ...
    function id(a, b) {
        if (b.position) Zc(), window.scroll.apply(null, b.position), b.s = !0;
            ...
            if (a = document.getElementById(a[2])) Zc(), a.scrollIntoView(), b.s = !0
    ...
    function ed(a, b, c) {
        try {
            ...
            }), N(a, !0) != window.location.href && kb(!1, a, {
                "spf-referer": b
            })
        } catch (d) {
            ad(), c(a, d)
    ...
    var hd, xd = window.performance && (window.performance.clearResourceTimings || window.performance.webkitClearResourceTimings || window.performance.mozClearResourceTimings || window.performance.msClearResourceTimings || window.performance.oClearResourceTimings);
    ...
    function yd() {
        Jb("js");
        Jb("css");
        "complete" == document.readyState && (document.removeEventListener ? document.removeEventListener("DOMContentLoaded", yd, !1) : document.detachEvent && document.detachEvent("onreadystatechange", yd))
    }
    document.addEventListener ? document.addEventListener("DOMContentLoaded", yd, !1) : document.attachEvent && document.attachEvent("onreadystatechange", yd);
    yd();
    var zd = {
            init: function(a) {
                var b = !("function" != typeof window.history.pushState && !mb().contentWindow.history.pushState);
                a = a || {};
            ...
            navigate: function(a, b) {
                a && (a = zb(a), Qc(a) ? Rc() ? Uc(a, b || {}, new Vc) : X(a, "1") : X(a, "9"))
            },
            load: function(a, b) {
                a = zb(a);
                qd(a, b || {}, new Vc)
