(function() {
    ...
    */
    ...
    function v(a) {
        if (w !== w) throw Error("SafeUrl is not meant to be built directly");
        this.g = a
    }
    ...
    function y() {
        if (x !== x) throw Error("SafeStyle is not meant to be built directly");
    }
    ...
    function A() {
        if (z !== z) throw Error("SafeStyleSheet is not meant to be built directly");
    }
    ...
    */
    ...
    var H = window.performance && window.performance.timing && window.performance.now ? function() {
    ...
    var R = String.prototype.trim ? function(a) {
        return a.trim()
    } : function(a) {
    ...
    function ja(a) {
        a.data && "[object String]" == Object.prototype.toString.call(a.data) && 0 == a.data.lastIndexOf("spf:", 0) && ka(a.data.substring(4))
    }
    ...
    T = M["async-defers"];
    na && ("async-listener" in M && ma(M["async-listener"]), la(ja), L("async-listener", ja));
    var oa = {};
    "ps-s" in M || L("ps-s", oa);
    oa = M["ps-s"];
    ...
    */
    function va(a, b, c) {
        if (b) {
            ...
            e = a.indexOf("]\r\n", d); - 1 < e && (f = R(a.substring(d, e)), d = e + 3, f && b.push(JSON.parse(f)));
            f = "";
            a.length > d && (f = a.substring(d), c && Q(f, "\r\n") && (f = f.substring(0, f.length - 2)));
            b = V(b);
            return {
                m: b,
                h: f
    ...
    function W(a) {
        var b = new wa;
        if (!a) return b;
        if ("[object String]" != Object.prototype.toString.call(a)) return a.scripts && I(a.scripts, function(c) {
            b.scripts.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || "",
        ...
        }), a.styles && I(a.styles, function(c) {
            b.styles.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || ""
            })
        }), a.links && I(a.links, function(c) {
        ...
        a = a.replace(xa, function(c, d, e, f) {
            ...
            return "style" == d && (d = (d = e.match(X)) ? d[1] : "", e = Aa.exec(e), e = !e || -1 != e[1].indexOf("text/css")) ? (b.styles.push({
                url: "",
                text: f,
                name: d
            }), "") : c
        ...
        a = a.replace(Ba, function(c, d) {
            var e = d.match(Ca);
            e = e ? e[1] : "";
            return "stylesheet" == e ? (e = (e = d.match(X)) ? e[1] : "", d = (d = d.match(Da)) ? d[1] :
                "", b.styles.push({
                    url: d,
                    text: "",
                    name: e
                }), "") : "spf-preconnect" == e ? (d = (d = d.match(Da)) ? d[1] : "", b.links.push({
                url: d,
                rel: e
            }), "") : c
        });
    ...
    function wa() {
        ...
        return "transition" in a.style ? !0 : J(["webkit", "Moz", "Ms", "O", "Khtml"], function(b) {
            return b + "Transition" in a.style
        })
    })();
    var Ba = /\x3clink([\s\S]*?)\x3e/ig,
        xa = /\x3c(script|style)([\s\S]*?)\x3e([\s\S]*?)\x3c\/\1\x3e/ig,
        za = /(?:\s|^)async(?:\s|=|$)/i,
        Da = /(?:\s|^)href\s*=\s*["']?([^\s"']+)/i,
        X = /(?:\s|^)name\s*=\s*["']?([^\s"']+)/i,
        Ca = /(?:\s|^)rel\s*=\s*["']?([^\s"']+)/i,
    ...
    function Ea(a, b, c, d) {
        ...
        g.onreadystatechange = function() {
            ...
            if (2 == g.readyState) {
                ...
                else if (N["assume-all-json-requests-chunked"] || -1 < (g.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked")) f = !0;
                else {
                ...
                e.u && e.u(g)
            } else 3 == g.readyState ? f && e.l && (q = g.responseText.substring(h), h = g.responseText.length, e.l(g, q)) : 4 == g.readyState && (q.responseEnd = q.responseEnd || H(), window.performance && window.performance.getEntriesByName && (g.resourceTiming = window.performance.getEntriesByName(b).pop()), f && e.l && g.responseText.length > h && (q = g.responseText.substring(h), h = g.responseText.length, e.l(g, q)), clearTimeout(k), e.s && e.s(g))
        };
    ...
    function Fa(a, b, c, d, e) {
        ...
        b.type && 0 == b.type.lastIndexOf("navigate", 0) && (c.navigationStart = c.startTime, N["cache-unified"] || (O(d), f = !0));
        b.j && "multipart" == e.type && I(e.parts, function(h) {
            h.timing || (h.timing = {});
    ...
    function Ja(a, b, c, d, e) {
        ...
        if (e.resourceTiming)
            ...
            for (var k in e.resourceTiming) h = e.resourceTiming[k], void 0 !== h && (Q(k, "Start") || Q(k, "End") || "startTime" == k) && (c[k] = f + Math.round(h));
        "load" != b.type && (c.navigationStart = c.startTime);
        d.g.length &&
            (d.h = R(d.h), d.h && Ia(a, b, c, d, e, "", !0));
        ...
        if (b.j && 1 < g.length)
            for (d = d.g.length; d < g.length; d++) e = g[d], e.timing || (e.timing = {}), e.timing.spfCached = !!c.spfCached, e.timing.spfPrefetched = !!c.spfPrefetched, b.j(a, e);
        if (1 < g.length) {
            var m;
            I(g, function(t) {
    ...
    function Ga(a, b, c, d, e) {
        if (e && "POST" != b.method && (e = Ka(a, b.current, d.cacheType, b.type, !0))) {
            d.cacheKey = e;
            var f = {
                    response: d,
                    type: b.type || ""
    ...
    function Ka(a, b, c, d, e) {
        a = pa(a);
        var f;
        N["cache-unified"] ? f = a : "navigate-back" == d || "navigate-forward" == d ? f = "history " + a : "navigate" == d ? f = (e ? "history " : "prefetch ") + a : "prefetch" == d && (f = e ? "prefetch " + a : "");
        b && "url" == c ? f += " previous " + b : b && "path" == c && (f += " previous " + U(b).pathname);
        return f || ""
    }

    function La(a, b) {
        var c = [];
        b && (c.push(a + " previous " + b), c.push(a + " previous " + U(b).pathname));
        c.push(a);
        var d = null;
        J(c, function(e) {
            a: {
            ...
            request: function(a, b) {
                ...
                if (d) {
                    ...
                    if (0 == d.lastIndexOf("?", 0)) h && (d = d.replace("?", "&")), f += d;
                        ...
                        else Q(c, "/") && 0 == d.lastIndexOf("/", 0) && (d = d.substring(1));
                        c += d
                    }
                    c = c + h + f + k + e
                }
                ...
                if (h) {
                    ...
                    if (m = N["advanced-header-identifier"]) h["X-SPF-Request"] = m.replace("__type__", b.type), h.Accept = "application/json";
                    m = new Ma;
                    f = G(Ja, null, a, b, c, m);
                    a = {
                        headers: h,
                    ...
                    a = "POST" == b.method ? Ea("POST", d, b.D, a) : Ea("GET", d, null, a)
                }
                return a
            }
        },
